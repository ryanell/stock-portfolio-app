...
export default function HoldingsList({ portfolioId }) {
    ...
    const loadHoldings = async () => {
        console.log('Loading holdings for portfolio:', portfolioId)
        setLoading(true)
        try {
            const data = await portfolioService.getHoldings(portfolioId)
            console.log('Loaded holdings from database:', data)
            setHoldings(data)
    ...
    const handleEditSuccess = async () => {
        console.log('Edit success - reloading holdings...')
        await loadHoldings() // Wait for reload to complete
